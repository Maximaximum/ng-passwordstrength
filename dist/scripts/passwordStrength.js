    ...
    angular.module('Maximaximum-ngPasswordStrength').factory('passwordStrength', function () {
        ...
        return {
            ...
            calculate: function calculate(password) {
                ...
                // Additions
                'characters', 'uppercaseCharacters', 'lowercaseCharacters', 'numbers', 'symbols', 'middleNumbersOrSymbols', 'requirements',

                // Deductions
                'lettersOnly', 'numbersOnly', 'repeatCharacters', 'consecutiveUppercaseCharacters', 'consecutiveLowercaseCharacters', 'consecutiveNumbers', 'sequentialCharacters', 'sequentialNumbers', 'sequentialSymbols', 'dictionary'],
                    i = 0;
            ...
            characters: function characters(password) {
                return password.length * 4;
            },
            uppercaseCharacters: function uppercaseCharacters(password) {
            ...
            lowercaseCharacters: function lowercaseCharacters(password) {
            ...
            numbers: function numbers(password) {
            ...
            symbols: function symbols(password) {
            ...
            middleNumbersOrSymbols: function middleNumbersOrSymbols(password) {
            ...
            requirements: function requirements(password) {
                ...
                */
                ...
                var requirements_matched = 1,
                    // Base 1 for password length
            ...
            lettersOnly: function lettersOnly(password) {
            ...
            numbersOnly: function numbersOnly(password) {
            ...
            repeatCharacters: function repeatCharacters(password) {
            ...
            consecutiveUppercaseCharacters: function consecutiveUppercaseCharacters(password) {
            ...
            consecutiveLowercaseCharacters: function consecutiveLowercaseCharacters(password) {
            ...
            consecutiveNumbers: function consecutiveNumbers(password) {
            ...
            consecutiveCount: function consecutiveCount(password, regex) {
            ...
            sequentialCharacters: function sequentialCharacters(password) {
            ...
            sequentialNumbers: function sequentialNumbers(password) {
            ...
            sequentialSymbols: function sequentialSymbols(password) {
            ...
            sequentialCount: function sequentialCount(password, characters) {
            ...
            dictionary: function dictionary(password) {

                var common_passwords = ['password', '123456', '12345678', 'abc123', 'qwerty', 'monkey', 'letmein', 'dragon', '111111', 'baseball', 'iloveyou', 'trustno1', '1234567', 'sunshine', 'master', '123123', 'welcome', 'shadow', 'ashley', 'football', 'jesus', 'michael', 'ninja', 'mustang', '1234', 'pussy', '12345', '696969', 'pass', 'fuckme', '6969', 'jordan', 'harley', 'ranger', 'iwantu', 'jennifer', 'hunter', 'fuck', '2000', 'test', 'batman', 'thomas', 'tigger', 'robert', 'access', 'love', 'buster', 'soccer', 'hockey', 'killer', 'george', 'sexy', 'andrew', 'charlie', 'superman', 'asshole', 'fuckyou', 'dallas', '123456789', 'adobe123', 'photoshop', '1234567890', '000000', 'adobe1', 'macromedia', 'azerty', 'aaaaaa', '654321', '666666', '123321', 'asdfgh', 'password1', 'princess', 'adobeadobe', 'daniel', 'computer', '121212', 'qwertyuiop', '112233', 'asdfasdf', 'jessica', '1q2w3e4r', '1qaz2wsx', '987654321', 'fdsa', '753951', 'chocolate', 'asdasd', 'asdfghjkl', 'internet', 'michelle', '123qwe', 'zxcvbnm', 'dreamweaver', '7777777', 'maggie', 'qazwsx', 'abcd1234', '555555', 'liverpool', 'abc', 'whatever', '11111111', '102030', '123123123', 'andrea', 'pepper', 'nicole', 'abcdef', 'hannah', 'alexander', '222222', 'joshua', 'freedom', 'samsung', 'asdfghj', 'purple', 'ginger', '123654', 'matrix', 'secret', 'summer', '1q2w3e', 'snoopy1', 'panties', '1111', 'austin', 'william', 'golfer', 'heather', 'hammer', 'yankees', 'biteme', 'enter', 'thunder', 'cowboy', 'silver', 'richard', 'fucker', 'orange', 'merlin', 'corvette', 'bigdog', 'cheese', 'matthew', 'patrick', 'martin', 'blowjob', 'sparky', 'yellow', 'camaro', 'dick', 'falcon', 'taylor', '131313', 'bitch', 'hello', 'scooter', 'please', 'porsche', 'guitar', 'chelsea', 'black', 'diamond', 'nascar', 'jackson', 'cameron', 'amanda', 'wizard', 'xxxxxxxx', 'money', 'phoenix', 'mickey', 'bailey', 'knight', 'iceman', 'tigers', 'horny', 'dakota', 'player', 'morgan', 'starwars', 'boomer', 'cowboys', 'edward', 'charles', 'girls', 'booboo', 'coffee', 'xxxxxx', 'bulldog', 'ncc1701', 'rabbit', 'peanut', 'john', 'johnny', 'gandalf', 'spanky', 'winter', 'brandy', 'compaq', 'carlos', 'tennis', 'james', 'mike', 'brandon', 'fender', 'anthony', 'blowme', 'ferrari', 'cookie', 'chicken', 'maverick', 'chicago', 'joseph', 'diablo', 'sexsex', 'hardcore', 'willie', 'chris', 'panther', 'yamaha', 'justin', 'banana', 'driver', 'marine', 'angels', 'fishing'];

                return common_passwords.indexOf(password) !== -1 ? -Infinity : 0;
            },
            bounds: function bounds(strength) {
